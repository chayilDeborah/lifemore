          ...
          <div className="flex items-center justify-between text-center lg:mt-[0px] mt-[20px]">
            <div className="flex z-[20]">
              <Image
                src={lifelogo}
                alt="icon"
                className="w-[64px] lg:w-[74px] lg:h-[74px] h-[64px] z-20"
              />
            ...
            <div className="hidden lg:flex justify-between w-[652px] items-center">
              <div className="text-[#22366C] text-[20px] leading-[32.4px] hover:bg-[#CD2785] hover:opacity-[0.699999988079071] hover:text-[#fff] cursor-pointer hover:px-[12px] hover:py-[8px]">
                <Link href="/">Home</Link>
              </div>
              <div className="text-[#22366C] text-[20px] leading-[32.4px] hover:bg-[#CD2785] hover:opacity-[0.699999988079071] hover:text-[#fff] cursor-pointer hover:px-[12px] hover:py-[8px]">
              ...
              <button className="bg-[#CD2785] text-[#fff] text-[20px] leading-[32.4px] opacity-[0.699999988079071] px-[24px] py-[16px] hover:text-[white] hover:bg-[#7537F6] hover:opacity-[1]">
            ...
            <div className="MOBILE-MENU flex lg:hidden">
              ...
              <div className={isNavOpen ? "showMenuNav" : "hideMenuNav"}>
                ...
                <div className="flex-row space-y-[15px] justify-between items-center">
                  <div className="text-[#22366C] text-[20px] leading-[32.4px] hover:bg-[#7537F6] hover:opacity-[0.699999988079071] hover:text-[#fff] cursor-pointer hover:px-[12px] hover:py-[15px]">
                    <Link href="/">Home</Link>
                  </div>
                  <div className="text-[#22366C] text-[20px] leading-[32.4px] hover:bg-[#7537F6] hover:opacity-[0.699999988079071] hover:text-[#fff] cursor-pointer hover:px-[12px] hover:py-[15px]">
                    <Link href="/about">About Us</Link>
