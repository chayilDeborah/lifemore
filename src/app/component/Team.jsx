  ...
  return (
    <>
      <div className="lg:w-[100%] w-[90%] mx-auto lg:mx-[0]">
        ...
        <div className="grid grid-cols-1 space-y-[25px] lg:space-y-[0px] lg:grid-cols-3 mb-[100px]">
          <div>
            <Image src={inspiration} alt="icon" className="w-[298px] h-[345px] lg:w-[358px] lg:h-[405px] mx-auto lg:mx-[0]"/>
            <div className="text-[#000] text-[20px] leading-[150%] mb-[10px] lg:mt-[24px] mt-[15px]  font-semibold text-center">
              Amb. Ayodeji Inspiration{" "}
            </div>
          ...
          <div>
            <Image src={ayo} alt="icon" className="w-[298px] h-[345px] lg:w-[358px] lg:h-[405px] mx-auto lg:mx-[0]"/>
            <div className="text-[#000] text-[20px] leading-[150%] mb-[10px] lg:mt-[24px] mt-[15px] font-semibold text-center">
          ...
          <div>
            <Image src={funmi} alt="icon" className="w-[298px] h-[345px] lg:w-[358px] lg:h-[405px] mx-auto lg:mx-[0]"/>
            <div className="text-[#000] text-[20px] leading-[150%] mb-[10px] lg:mt-[24px] mt-[15px] font-semibold text-center">
