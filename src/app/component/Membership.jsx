    ...
    <div className='flex justify-center bg-gradient-radial from-[#4C409A] to-[#12084F] mt-[150px]'>
      <div className='w-[80%]'>
        <div className='w-[100%] bg-[#FFF] shadow-3xl -mt-[70px] flex justify-center rounded-[5px]'>
            <div>
            <Image src={color} alt='icon' className='ml-auto mr-[23px] mt-[27px] mb-[17px]'/>
            <div className='w-[100%] max-w-7xl mx-auto grid grid-cols-2 '>
...
<form>
    <div class="grid gap-6 mb-6 lg:grid-cols-2">
        <div>
            ...
            <input type="text" id="first_name" class="bg-[#fff] border border-[#A09CB9]  rounded-[4px] focus:ring-[#413972] pl-[10px] focus:border-[#A09CB9] block w-[200px] h-[46px]"  required/>
        </div>
        <div>
            <label for="last_name" class="block mb-[9.19px] text-[13px] text-[#413972] leading-[14px] ">Last name *</label>
            <input type="text" id="last_name" class="bg-[#fff] border border-[#A09CB9]  rounded-[4px] focus:ring-[#413972] pl-[10px] focus:border-[#A09CB9] block w-[200px] h-[46px]" required/>
        </div>  
        
    </div>
    <div class="mb-6">
            <label for="phone" class="block mb-[9.19px] text-[13px] text-[#413972] leading-[14px] ">Phone number *</label>
            <input type="tel" id="phone" class="bg-[#fff] border border-[#A09CB9]  rounded-[4px] focus:ring-[#413972] focus:border-[#A09CB9] block pl-[10px] lg:w-[452px] h-[46px]" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required/>
        </div>
    <div class="mb-6">
        <label for="email" class="block mb-[9.19px] text-[13px] text-[#413972] leading-[14px] ">Email address *</label>
        <input type="email" id="email" class="bg-[#fff] border border-[#A09CB9]  rounded-[4px] focus:ring-[#413972] focus:border-[#A09CB9] block pl-[10px] lg:w-[452px] h-[46px]"  required/>
    </div> 
    <div class="mb-6">
    <label for="password" class="block mb-[9.19px] text-[13px] text-[#413972] leading-[14px] "> Password *</label>
      ...
      <input
        ...
        className="lg:w-[452px] h-[46px] pl-[10px]
        text-base
    ...
    <button type="submit" className='bg-[#7537F6] text-[#fff] text-[14.56px] font-black leading-[18.216px] tracking-[1.159px] lg:w-[452px] hover:opacity-[0.699999988079071] rounded-[6px] mb-[200px] py-[15px]'>Sign up for Membership</button>
</form>
